...
"
    ...
    <div className='right mt-lg-5' style={top}>
        ...
        <div className="login-container">
            ...
            <button className="signup-btn bg-priamry mt-3" name="submit" id="loginFunCode">
                Sign In
            </button>
            <p className="mt-2 w-full " style={{textAlign:'right'}}><a href="forgot-password.html" className='mt-1 d-block text-right'>Forgot Password?</a></p>
